...
export default function SideBar(props) {
    ...
    return (  
        <>
            <div className={(props.hide ? " -translate-x-full " : "") + " absolute transform duration-300 select-none z-40 left-0 top-0 h-full pt-20 w-auto flex flex-col justify-start items-center border-black border-opacity-20 bg-black bg-opacity-20"}>
                {
                    (
...
export function AllApps(props) {
    ...
    return (
        ...
        >
            <img className="w-7" src="./themes/Yaru/system/view-app-grid-symbolic.svg" alt="view app" />
            <div
                className={
