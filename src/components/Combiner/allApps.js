        ...
        return (
            <div className={"absolute h-full top-7 w-full z-20 justify-center pl-20 border-black border-opacity-60 bg-black bg-opacity-70"}>
                <div className={"flex p-5 align-center justify-center"}>
                    <div className={"flex w-1/4 h-full items-center pl-2 pr-2 bg-white bg-opacity-100 border-black border-width-2 rounded-xl overflow-hidden "}>
                        <img className={"w-5 h-5 "} alt="search icon" src={'./images/logos/search.png'}  />
                        <input className={"w-3/4 p-1 bg-transparent focus:outline-none text-black opacity-50 "}
